...
import { MAYAName } from "./types/type_mayaname";
...
export const lastChainHeight = {
  ...
  create<I extends Exact<DeepPartial<lastChainHeight>, I>>(base?: I): lastChainHeight {
    return lastChainHeight.fromPartial(base ?? {});
  },
...
export const GenesisState = {
  encode(message: GenesisState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.mayanames) {
      MAYAName.encode(v!, writer.uint32(186).fork()).ldelim();
    }
    ...
    if (!message.mayaFund.isZero()) {
      writer.uint32(224).uint64(message.mayaFund);
    }
    if (!message.asgard.isZero()) {
      writer.uint32(232).uint64(message.asgard);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 22:
          ...
          break;
        case 23:
          message.mayanames.push(MAYAName.decode(reader, reader.uint32()));
          break;
        case 24:
        ...
        case 27:
          ...
          break;
        case 28:
          message.mayaFund = reader.uint64() as Long;
          break;
        case 29:
          message.asgard = reader.uint64() as Long;
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      chainContracts: Array.isArray(object?.chainContracts)
        ...
        : [],
      mayanames: Array.isArray(object?.mayanames)
        ? object.mayanames.map((e: any) => MAYAName.fromJSON(e))
        : [],
      ...
      mayaFund: isSet(object.mayaFund) ? Long.fromValue(object.mayaFund) : Long.UZERO,
      asgard: isSet(object.asgard) ? Long.fromValue(object.asgard) : Long.UZERO,
    };
  },
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.mayanames) {
      obj.mayanames = message.mayanames.map((e) => e ? MAYAName.toJSON(e) : undefined);
    } else {
      obj.mayanames = [];
    }
    if (message.mimirs) {
    ...
    message.mayaFund !== undefined && (obj.mayaFund = (message.mayaFund || Long.UZERO).toString());
    message.asgard !== undefined && (obj.asgard = (message.asgard || Long.UZERO).toString());
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(object: I): GenesisState {
    ...
    message.mayanames = object.mayanames?.map((e) => MAYAName.fromPartial(e)) || [];
    ...
    message.POL = (object.POL !== undefined && object.POL !== null)
      ...
      : undefined;
    message.mayaFund = (object.mayaFund !== undefined && object.mayaFund !== null)
      ? Long.fromValue(object.mayaFund)
      : Long.UZERO;
    message.asgard = (object.asgard !== undefined && object.asgard !== null)
      ? Long.fromValue(object.asgard)
      : Long.UZERO;
    return message;
  },
};
