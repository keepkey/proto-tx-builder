...
function createBaseNode(): Node {
  return { pubkey: "", blameData: new Uint8Array(), blameSignature: new Uint8Array() };
}
...
export const Node = {
  ...
  toJSON(message: Node): unknown {
    ...
    message.blameData !== undefined &&
      (obj.blameData = base64FromBytes(message.blameData !== undefined ? message.blameData : new Uint8Array()));
    message.blameSignature !== undefined &&
      (obj.blameSignature = base64FromBytes(
        message.blameSignature !== undefined ? message.blameSignature : new Uint8Array(),
      ));
    return obj;
  },
...
export const Blame = {
  ...
  fromJSON(object: any): Blame {
    return {
      ...
      round: isSet(object.round) ? String(object.round) : "",
    };
  },
