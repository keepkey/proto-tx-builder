...
export interface MsgManageMAYAName {
  name: string;
  chain: string;
  address: string;
  coin?: Coin;
...
function createBaseMsgManageMAYAName(): MsgManageMAYAName {
  return {
    name: "",
    chain: "",
    address: "",
...
export const MsgManageMAYAName = {
  encode(message: MsgManageMAYAName, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgManageMAYAName {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgManageMAYAName();
  ...
  fromJSON(object: any): MsgManageMAYAName {
    return {
  ...
  toJSON(message: MsgManageMAYAName): unknown {
    const obj: any = {};
  ...
  create<I extends Exact<DeepPartial<MsgManageMAYAName>, I>>(base?: I): MsgManageMAYAName {
    return MsgManageMAYAName.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<MsgManageMAYAName>, I>>(object: I): MsgManageMAYAName {
    const message = createBaseMsgManageMAYAName();
