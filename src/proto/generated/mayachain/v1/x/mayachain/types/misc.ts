...
function createBaseProtoFloat64(): ProtoFloat64 {
  return { value: 0 };
}

export const ProtoFloat64 = {
  encode(message: ProtoFloat64, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.value !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ProtoFloat64 {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseProtoFloat64();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): ProtoFloat64 {
    return { value: isSet(object.value) ? Number(object.value) : 0 };
  },

  toJSON(message: ProtoFloat64): unknown {
    const obj: any = {};
    message.value !== undefined && (obj.value = message.value);
    return obj;
  },

  create<I extends Exact<DeepPartial<ProtoFloat64>, I>>(base?: I): ProtoFloat64 {
    return ProtoFloat64.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<ProtoFloat64>, I>>(object: I): ProtoFloat64 {
    const message = createBaseProtoFloat64();
